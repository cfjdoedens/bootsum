...
ui <- fluidPage(
    ...
    sidebarLayout(
        sidebarPanel(
            helpText("Upload een CSV-bestand met je steekproef. De app gaat ervan uit dat SOLL-bedragen (SOLL: de volgens de auditor juiste waarden; soms in afwijking van de in de administratie aangetroffen waarden, de IST-bedragen) in de eerste kolom staan."),
